package com.kredivation.pankh.Profile;
...
import com.kredivation.pankh.Following.Following_F;
import com.kredivation.pankh.Main_Menu.RelateToFragment_OnBack.RootFragment;
import com.kredivation.pankh.Profile.Liked_Videos.Liked_Video_F;
import com.kredivation.pankh.Profile.UserVideos.UserVideo_F;
import com.kredivation.pankh.See_Full_Image_NN;
...
public class Profile_F extends RootFragment implements View.OnClickListener {
   ...
   public  TextView follow_count_txt,fans_count_txt,heart_count_txt;
    ...
    String user_id,user_name,user_pic,usernameId;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(bundle!=null){
            ...
            //usernameId=bundle.getString("usernameId");
        }
...
//show user all videos and liked videos
    ...
    public void Parse_data(String responce){
        try {
            ...
            if(code.equals("200")){
                ...
                userid.setText(user_info.optString("usernameId"));
    ...
    public void OpenfullsizeImage(String url){
        See_Full_Image_NN see_image_f = new See_Full_Image_NN();

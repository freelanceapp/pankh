package com.kredivation.pankh.SoundLists;
...
import com.kredivation.pankh.Video_Recording.Video_Recoder_A;
...
public class VideoSound_A extends AppCompatActivity implements View.OnClickListener {
 ...
 /*   public void Load_FFmpeg() {
        show_audio_loading();
       *//* startEncode(Variables.app_folder + item.video_id + ".mp4", 0, 0, 0, null, null,
                2059, "540x960", "24.86", null, 48000, "1",
                70, Variables.app_folder + Variables.SelectedAudio_MP3);
*//*
...
*//*
  ...
  /*  public void Extract_sound() {
        ...
        String[] cmd = {"-y", "-i", Variables.app_folder + item.video_id + ".mp4", "-b:v", "512k", "-s", "640x640", "-r", "24", "-vcodec", "libx264", "-strict", "-2", Variables.app_folder + Variables.SelectedAudio_MP3};
    ...
    public void videotoAudioExtractor() {
       /* Usage:

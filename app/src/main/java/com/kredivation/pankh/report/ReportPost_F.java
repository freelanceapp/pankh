...
public class ReportPost_F extends RootFragment implements SelectableViewHolder.OnItemSelectedListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
     ...
     /*   adapter = new ReportAdapter(context, data_list, new ReportAdapter.OnItemClickListener() {
        ...
        adapter = new ReportAdapter(this,data_list,false);
        ...
        view.findViewById(R.id.save_btn).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (reportTypeID > 0) {
                    ...
                    Snackbar.make(recyclerView,"Please select anyone option!",Snackbar.LENGTH_LONG).show();
                }
            }
        });
        return view;
    ...
    @Override
    public void onItemSelected(SelectableReport selectableItem) {
        List<ReportData> selectedItems = adapter.getSelectedItems();
        for(ReportData data:selectedItems){
            reportTypeID=data.getId();
        }

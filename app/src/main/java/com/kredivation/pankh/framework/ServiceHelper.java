package com.kredivation.pankh.framework;
...
import com.kredivation.pankh.SimpleClasses.TucTuc;
...
public class ServiceHelper implements IServiceHelper {
    ...
    public void callService(String url, JSONObject jsonInputObj, final IServiceSuccessCallback c) {
        ...
        JsonObjectRequest jsonObjReq = new JsonObjectRequest(Request.Method.POST,
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                            Log.d(Variables.tag, "successfully called " + callerUrl);
            ...
            public void onErrorResponse(VolleyError error) {
                    Log.d(Variables.tag, "error at ServiceHelper: callService " + callerUrl + ": " + error.getMessage());
        ...
        jsonObjReq.setRetryPolicy(new DefaultRetryPolicy(110 * 1000, 0, 1.0f));
        TucTuc.getInstance().addToRequestQueue(jsonObjReq);//, tag_json_obj);
    ...
    public void callJsonArryService(String url, final Map<String, String> params, final IServiceSuccessCallback c) {
        ...
        TucTuc.getInstance().addToRequestQueue(jsonarray);//, tag_json_obj);
